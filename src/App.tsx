...
💳 К оплате: ${total} руб.
  ...
  const documents = {
    offer: `
      <h2>Оферта</h2>
<p>Настоящая оферта определяет условия предоставления услуг онлайн-сервиса, размещённого по адресу: [укажите URL вашего сайта]. Акцепт оферты Пользователем означает полное согласие с условиями настоящего договора.</p>
...
<p>Настоящая Политика конфиденциальности определяет правила сбора, использования, хранения и защиты персональных данных пользователей сайта [укажите URL вашего сайта] (далее — «Сайт»).</p>
<p>Дата публикации: 14.08.2025</p>
<p>Редакция от: 14.08.2025</p>
